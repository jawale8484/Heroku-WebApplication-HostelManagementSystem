...
<body>
	...
	<div class="b">
		<div class="topnav">
			<nav>
				<a href="contactinfo.jsp">ContactInfo</a> 
		 <a href="bookinginfo.jsp">BookingInfo</a>
		  
		      <a href="login.jsp">LogOut</a>
		   
			</nav>
		</div>
		<strong style="font-size: 40px; margin-left: 28%;">
			Booking-Info
			</strong> 
		<br>
  ...
  border: 2px solid black;
			...
			try {
				...
				conn = (Connection) DriverManager.getConnection("jdbc:postgresql://ec2-54-155-208-5.eu-west-1.compute.amazonaws.com:5432/d79bi2rgccst7k", "ljvttuttcqsnck", "97d5588536968135d3f0ccd80f9139de38ae61a6cc6c8f3db2897cfe4ab6365f");
